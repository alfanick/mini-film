...
pub(crate) use crate::util::{
    ...
    is_heic_input_file, is_jpeg_input_file, is_raw_input_file, is_supported_input_file,
    is_supported_raw_file, matching_raw_for_sidecar, matching_sidecar_for_raw, remove_temp_file,
    time_of_day_seed,
};
