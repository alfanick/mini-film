...
struct DaemonFileResult {
    ...
    lcp_profile_filename: Option<String>,
    error: Option<String>,
...
impl Clone for DaemonFileResult {
    fn clone(&self) -> Self {
        Self {
            ...
            lcp_profile_filename: self.lcp_profile_filename.clone(),
            ...
            if let Some(error) = &result.error {
                ...
                let _ = if let Some(image_id) = review_image_id {
                    review.record_profile_done_with_dcp_for_image(
                        ...
                        result.lcp_profile_filename.as_deref(),
                    )
                } else {
...
fn process_single_profile(
    ...
    let lcp_profile_filename = apply_outcome.lcp_profile_filename;
