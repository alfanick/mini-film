...
import { formatPercent } from "../tools/diffusion-helpers";
...
/** Current diffusion state, shared formatting helpers, and lifecycle actions for the comparison components. */
export interface DiffusionViewDependencies {
  DIFFUSION_DETAIL_AREAS: typeof import("../core/constants").DIFFUSION_DETAIL_AREAS;
  DIFFUSION_METHODS: typeof import("../core/constants").DIFFUSION_METHODS;
  DIFFUSION_PRESETS: typeof import("../core/constants").DIFFUSION_PRESETS;
  applyDiffusion: ToolsController["applyDiffusion"];
  closeDiffusion: ToolsController["closeDiffusion"];
  diffusionAfterSource: typeof import("../tools/diffusion-helpers").diffusionAfterSource;
  diffusionBeforeSource: ToolsController["diffusionBeforeSource"];
  diffusionDetailFrameStyle: typeof import("../tools/diffusion-helpers").diffusionDetailFrameStyle;
  diffusionDetailMediaStyle: typeof import("../tools/diffusion-helpers").diffusionDetailMediaStyle;
  diffusionMediaStyle: ToolsController["diffusionMediaStyle"];
  diffusionPresetIsActive: typeof import("../tools/diffusion-helpers").diffusionPresetIsActive;
  diffusionPresetSettings: typeof import("../tools/diffusion-helpers").diffusionPresetSettings;
  diffusionPreviewContext: ToolsController["diffusionPreviewContext"];
  diffusionProfile: typeof import("../tools/diffusion-helpers").diffusionProfile;
  diffusionSourceLabel: typeof import("../tools/diffusion-helpers").diffusionSourceLabel;
  diffusionStatusText: ToolsController["diffusionStatusText"];
  findImage: ToolsController["findImage"];
  formatPercent: typeof import("../tools/diffusion-helpers").formatPercent;
  normalizeDiffusionSettings: typeof import("../tools/diffusion-helpers").normalizeDiffusionSettings;
...
interface DiffusionComparisonProps {
  ...
  after: ReturnType<DiffusionViewDependencies["diffusionAfterSource"]>;
...
export function DiffusionOverlay(): ComponentChildren {
  ...
  return (
    <section class={"diffusion-card"} role={"dialog"} aria-modal={"true"} aria-labelledby={"diffusion-title"}>
...
export function DiffusionFullComparison({
  ...
  const { diffusionStatusText, reviewUrl, state, versionedUrl } = useDiffusionView();
  return (
...
export function DiffusionDetailComparisons({
  ...
  const { DIFFUSION_DETAIL_AREAS, diffusionStatusText, state } = useDiffusionView();
  return (
...
export function DiffusionDetailFigure({
  ...
  const { diffusionDetailFrameStyle, diffusionDetailMediaStyle, reviewUrl, versionedUrl } = useDiffusionView();
  return (
    <figure>
