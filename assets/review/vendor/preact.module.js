...
function I(n) {
  if (n.__P && n.__d) {
    ...
    ((o.__v = u.__v + 1),
      l.vnode && l.vnode(o),
      q(n.__P, o, u, n.__n, n.__P.namespaceURI, 32 & u.__u ? [t] : null, i, null == t ? $(u) : t, !!(32 & u.__u), r),
      (o.__v = u.__v),
      (o.__.__k[o.__i] = o),
      D(i, o, r),
      (u.__e = u.__ = null),
...
function A(n) {
  ((!n.__d && (n.__d = !0) && i.push(n) && !H.__r++) || r != l.debounceRendering) &&
...
function L(n, l, u, t, i, r, o, e, f, c, a) {
  ...
  for (f = T(u, l, m, f, b), s = 0; s < b; s++)
    null != (p = u.__k[s]) &&
      ((h = (-1 != p.__i && m[p.__i]) || d),
      (p.__i = s),
      (_ = q(n, p, h, i, r, o, e, f, c, a)),
      (v = p.__e),
      p.ref && h.ref != p.ref && (h.ref && J(h.ref, null, p), a.push(p.ref, p.__c || v, p)),
      null == y && null != v && (y = v),
      (g = !!(4 & p.__u)) || h.__k === p.__k
        ? ((f = j(p, f, n, g)), g && h.__e && (h.__e = null))
  ...
  for (n.__k = new Array(i), r = 0; r < i; r++)
    null != (o = l[r]) && "boolean" != typeof o && "function" != typeof o
      ? ("string" == typeof o || "number" == typeof o || "bigint" == typeof o || o.constructor == String
        ...
        (o.__b = n.__b + 1),
        (e = null),
        -1 != (c = o.__i = O(o, u, f, s)) && (s--, (e = u[c]) && (e.__u |= 2)),
        null == e || null == e.__v
  ...
  n: if ("style" == l)
    ...
    ((r = l != (l = l.replace(s, "$1"))),
      ...
      u
        ? t
          ? (u[a] = t[a])
          : ((u[a] = h), n.addEventListener(l, r ? v : p, r))
        : n.removeEventListener(l, r ? v : p, r));
  else {
...
function q(n, u, t, i, r, o, e, f, c, a) {
  ...
  n: if ("function" == typeof T)
    try {
      if (
        ((k = u.props),
        (x = T.prototype && T.prototype.render),
        (M = (s = T.contextType) && i[s.__c]),
        ($ = s ? (M ? M.props.value : s.__) : i),
        t.__c
          ? (_ = (h = u.__c = t.__c).__ = h.__E)
          : (x ? (u.__c = h = new T(k, $)) : ((u.__c = h = new C(k, $)), (h.constructor = T), (h.render = Q)),
            M && M.sub(h),
            h.state || (h.state = {}),
            (h.__n = i),
            (p = h.__d = !0),
        ...
        x &&
          ...
          (h.__s == h.state && (h.__s = m({}, h.__s)), m(h.__s, T.getDerivedStateFromProps(k, h.__s))),
        (v = h.props),
        (y = h.state),
        (h.__v = u),
        p)
      )
        (x && null == T.getDerivedStateFromProps && null != h.componentWillMount && h.componentWillMount(),
        ...
        if (
          (x &&
            ...
            h.componentWillReceiveProps(k, $),
          u.__v == t.__v || (!h.__e && null != h.shouldComponentUpdate && !1 === h.shouldComponentUpdate(k, h.__s, $)))
        ) {
          (u.__v != t.__v && ((h.props = k), (h.state = h.__s), (h.__d = !1)),
            (u.__e = t.__e),
            (u.__k = t.__k),
            u.__k.some(function (n) {
              n && (n.__ = u);
            }),
            w.push.apply(h.__h, h._sb),
            (h._sb = []),
            h.__h.length && e.push(h));
          break n;
        }
        (null != h.componentWillUpdate && h.componentWillUpdate(k, h.__s, $),
          x &&
      ...
      if (((h.context = $), (h.props = k), (h.__P = n), (h.__e = !1), (I = l.__r), (P = 0), x))
        ((h.state = h.__s),
          (h.__d = !1),
          I && I(u),
      ...
      ((h.state = h.__s),
        null != h.getChildContext && (i = m(m({}, i), h.getChildContext())),
        x && !p && null != h.getSnapshotBeforeUpdate && (d = h.getSnapshotBeforeUpdate(v, y)),
        (A = null != s && s.type === S && null == s.key ? E(s.props.children) : s),
        (f = L(n, g(A) ? A : [A], u, t, i, r, o, e, f, c, a)),
        (h.base = u.__e),
        (u.__u &= -161),
        h.__h.length && e.push(h),
        _ && (h.__E = h.__ = null));
    ...
    null == o && u.__v == t.__v ? ((u.__k = t.__k), (u.__e = t.__e)) : (f = u.__e = G(t.__e, u, t, i, r, o, e, c, a));
...
function K(n, u, t) {
  ...
  if (
    ...
    (i = n.ref) && ((i.current && i.current != n.__e) || J(i, null, u)),
    null != (i = n.__c))
  ) {
...
function W(l, u, t) {
  ...
  return (
    ...
    x(l.type, f, i || l.key, r || l.ref, null)
  );
}
function X(n) {
  function l(n) {
...
((n = w.slice),
  ...
  (C.prototype.setState = function (n, l) {
    var u;
    ((u = null != this.__s && this.__s != this.state ? this.__s : (this.__s = m({}, this.state))),
      "function" == typeof n && (n = n(m({}, u), this.props)),
      n && m(u, n),
      null != n && this.__v && (l && this._sb.push(l), A(this)));
  }),
